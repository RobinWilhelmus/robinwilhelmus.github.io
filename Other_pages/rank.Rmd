...
---
^[Find\ last\ season\ here](https://www.gettingbluefingers.com/rank-2021.html "Find last season here")^
...
df1 <- readxl::read_excel("Export_TDL_NED_2223.xlsx", 
                   sheet = "Wedstrijden") %>%
...
df2 <- readxl::read_excel("Export_TDL_NED_2223.xlsx", 
                   sheet = "Wedstrijden") %>%
...
xRank <- readxl::read_excel("Export_TDL_NED_2223.xlsx", 
                  sheet = "Stand")# %>% 
#  mutate(Form = NA)
